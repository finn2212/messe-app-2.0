<template>
  <div>
    <h1 class="text-base font-semibold text-gray-900">Admin - Marken-Attribute</h1>
    <p class="mt-2 text-sm text-gray-700">
      Hier findest du eine Liste aller Marken und die zugehörigen Attribute.
      Du kannst neue Marken erstellen, Attribute hinzufügen oder löschen.
      Außerdem kannst du optional ein Bild pro Marke hochladen.
    </p>
              ...
              <tbody class="divide-y divide-gray-200 bg-white">
                ...
                >
                  ...
                  <td class="whitespace-nowrap px-3 py-4 text-sm">
                    <div v-if="brandDoc.data.brandImageUrl" class="w-16 h-16 overflow-hidden">
                      <img
    ...
    <div class="bg-white shadow sm:rounded-lg p-4">
      ...
      <form @submit.prevent="saveBrandDoc" class="space-y-4">
        <!-- Markenname -->
        <div>
          <label class="block text-sm font-medium text-gray-700">Markenname</label>
          <input
        ...
        <!-- Bild -->
        <div>
          <label class="block text-sm font-medium text-gray-700">Marken-Bild (optional)</label>
          <div v-if="formData.brandImageUrl" class="mt-1 w-20 h-20 overflow-hidden">
            <img
